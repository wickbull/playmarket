...
return [
     ...
     *  orderSum
     */
    'searchOrderFilter' => 'App\Http\Controllers\PaymentController::searchOrderFilter',
     ...
     */
    'paidOrderFilter' => 'App\Http\Controllers\PaymentController::paidOrderFilter',
    ...
    'mail' => [
        'to' => env('UNITPAY_EMAIL_NOTIFICATION', ''),  // your email
    ],

    'slack' => [
        'webhook_url' => env('UNITPAY_SLACK_NOTIFICATION', ''), // slack web hook to send notifications
    ],
];
