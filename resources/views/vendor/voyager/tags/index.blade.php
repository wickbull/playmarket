...
@section('page_header')
    <h1 class="page-title">
        <i class=""></i> Список тегов
        <a href="{{ route('add-tag') }}" class="btn btn-success">
            <i class="voyager-plus"></i> Добавить тег
        </a>
    </h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/admin/delete-tag" id="delete_form" method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
